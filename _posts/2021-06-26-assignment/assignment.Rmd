...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, cache = FALSE, fig.retina = 3)
```
...
### 5.2.3 Plot Travel Time Perioids on Each Day for Each Personnel
...
```{r each personnel travel time period on each day, echo=FALSE, fig.height=10, fig.width=12}
...
#Add gender to gpsname!!Then distinguish by color in the plot
