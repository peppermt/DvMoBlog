...
txn_outliertab <- txn_outliertab %>% select(c("Location", "Price", "TimeStampFormatted", "last4ccnum","loyaltynum"))
                                            
data.table(txn_outliertab)    

```
We note that owner of credit card 4530 (and loyalty card L8477) and 2276 (and loyalty card L3317) own two of these high transaction amounts each. 
...
```{r car_assigned missing values show truck drivers, echo=FALSE, results=}
