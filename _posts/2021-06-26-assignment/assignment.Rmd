...
According to Robert Krueger, movement data is more complex to handle than simple point-based data as it contains complex hierarchical structures of overlapping trajectories with diverse shapes and directions. 
...
print_routes_ID_date(31,'2014-01-19 15:50:00','2014-01-19 18:56:00')
...
rmarkdown::paged_table(creditcard %>% filter(location == "Chostus Hotel"))
