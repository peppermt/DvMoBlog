...
```{r for time of the day, echo=FALSE, fig.height=10, fig.width=20, layout="1-body-outset"}
...
```{r trying out geom_tile, echo=FALSE, fig.height=10, fig.width=16, layout="1-body-outset"}
...
cc_colours4 <- colorRampPalette(c('green', 'yellow', 'orange', 'red'))(x4)
