...
Example of printing the route for car ID #, on a specific date time period.

```{r trying out the print_route function, echo=TRUE}

print_routes_ID_date(101,'2014-01-18 00:00:00','2014-01-18 23:59:00')
...
#Write to csv
#write.csv(gpsnamegender,"C:\\Users\\tongr\\OneDrive - Singapore Management University\\Course Mat SMU\\Term #2\\Visual Analytics\\Assignment\\gpsnamegender2.csv")

#write.csv(namedistinct,"C:\\Users\\tongr\\OneDrive - Singapore Management University\\Course #Mat SMU\\Term 2\\Visual Analytics\\Assignment\\namedistinct.csv")


#Can clean these up eventually
#namelist <- list()
#for(i in 1:nrow(namedistinct)) {
  #namelist[[i]] <- namedistinct[i,]
#}
#head(namelist)
...
```{r plotting the individual charts for the other groups, echo=FALSE}
...
```{r Look at CC and Loyalty Card Matched, echo=FALSE}
...
(Just plot and compile the tracking routes for all 5 from second week onwards - ie 25 plots).
...
### Question 5
* For Suspicious Activities - Check for:_
